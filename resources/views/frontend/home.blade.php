                                ...
                                <div class="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
                                    @auth
                                        <form action="{{ route('wishlist.add') }}" method="POST">
                                            ...
                                            <button type="submit" 
                                                    class="w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition transform hover:scale-110 text-gray-400 hover:text-red-500"
