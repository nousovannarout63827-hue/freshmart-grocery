                                        ...
                                        <div class="absolute top-3 right-3">
                                            @auth
                                                <form action="{{ route('wishlist.add') }}" method="POST">
                                                    ...
                                                    <button type="submit" 
                                                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition transform hover:scale-110 text-gray-400 hover:text-red-500"
