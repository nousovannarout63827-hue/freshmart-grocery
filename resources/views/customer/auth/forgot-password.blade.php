...
@section('title', 'Forgot Password - FreshMart')
    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <form action="{{ route('customer.forgot-password') }}" method="POST" class="space-y-5">
                    @csrf
                ...
                <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm text-blue-800 font-medium">Didn't receive the email?</p>
                            <p class="text-xs text-blue-600 mt-1">Check your spam folder or try again in a few minutes.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 auth-bg items-center justify-center p-12 relative overflow-hidden">
            ...
            <div class="relative z-10 text-white text-center max-w-md">
                <h2 class="text-4xl font-bold mb-6">Secure Account Recovery</h2>
                <p class="text-green-100 text-lg mb-8">We'll send you a secure link to reset your password and regain access to your account.</p>
